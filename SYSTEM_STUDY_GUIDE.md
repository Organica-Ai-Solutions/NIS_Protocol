...
### **NIS Protocol v3.2.1**
- **Type:** AI Robotics Foundation / Cognitive Architecture
- **License:** Apache 2.0
...
- **Backend (FastAPI main API server)**
  ...
  - Core app package: `src/`
    ...
    - `src/services/` – NIS Hub services (pipeline, protocol bridge)
...
4. **pipeline** - Self-awareness & meta-cognition
...
**pipeline Service:**
- 5 levels of pipeline evaluation
...
- "How does the pipeline service validate decisions?"
